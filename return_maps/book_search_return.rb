...
=> {:data=>
  [{:id=>"ZXRxl3Bl2xMC",
   ...
   {:id=>"Z7RDDwAAQBAJ",
    :type=>"book_poro",
    :attributes=>
     {:title=>"Providence of a Sparrow",
      :authors=>["Chris Chester"],
   ...
   {:id=>"qGa3DAAAQBAJ",
    ...
    :attributes=>
     {:title=>"Little Bot and Sparrow",
      :authors=>["Jake Parker"],
      :genres=>["Juvenile Fiction"],
      :description=>"A little robot and a sparrow learn about friendship and saying goodbye in this sweet and moving picture book."}},
   {:id=>"1QXDjwEACAAJ",
    :type=>"book_poro",
    :attributes=>
     {:title=>"Sparrow",
